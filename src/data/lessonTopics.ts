 ...
 * copies of twelve titles is two copies that drift, and the one that drifts is
 * always the one nobody is looking at.
 *
 * Content only. Which photograph a section carries, which reaction families sit
 * under it and which poster its video uses all stay in the page, because they
 * are presentation and the dashboard has no use for them.
 */
