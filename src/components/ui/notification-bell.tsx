  ...
  return (
    <div ref={wrap} className={cn("relative", className)}>
      ...
      >
        ...
        {count > 0 && (
          <span className="absolute -top-0.5 -right-0.5 min-w-[1.15rem] rounded-full bg-[#5a3fd8] px-1 text-center font-mono text-[0.65rem] leading-[1.15rem] font-bold text-white">
            {count > 99 ? "99+" : count}
          </span>
        )}
      </button>
