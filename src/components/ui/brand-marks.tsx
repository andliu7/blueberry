/**
 * GitHub and LinkedIn marks, drawn inline.
 *
 * lucide-react dropped its brand icons, so `Github` and `Linkedin` are not
 * exported by the version installed here. Every other icon on the site comes
 * from lucide; these two are the exception because there is nothing to import.
 *
 * They take `currentColor` like a lucide icon does, so they drop into the same
 * places without special casing.
 */
