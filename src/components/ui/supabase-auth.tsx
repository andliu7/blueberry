    ...
    return (
      ...
      >
        ...
        <button
          ...
          className="flex min-h-11 w-full cursor-pointer items-center justify-center gap-2 rounded-xl gradient-button px-4 text-sm font-semibold text-white transition hover:brightness-110 disabled:opacity-60"
        >
      ...
      <form onSubmit={(e) => void submit(e)} className="flex flex-col gap-2.5">
        ...
        <button
          ...
          className={cn(
            ...
            "gradient-button px-4 text-sm font-semibold text-white",
