import{s as e,t}from"./react-Du4I-rQQ.js";import{ct as n,u as r}from"./site-DZUFzK2h.js";import{t as i}from"./jsx-runtime-Bq21bEWl.js";var a=n(`arrow-up-right`,[[`path`,{d:`M7 7h10v10`,key:`1tivn9`}],[`path`,{d:`M7 17 17 7`,key:`1vkiza`}]]),o={erlenmeyer:`
    ...
    <circle cx="118" cy="198" r="3.5" fill="#fff" opacity=".35"/>`,resonance:`
    ...
    <circle cx="198" cy="204" r="6" fill="#fff" opacity=".5"/>`,pka:`
    ...
    <circle cx="128" cy="148" r="17" fill="none" stroke="#fff" stroke-width="3.5" opacity=".45"/>`,benzene:`
    ...
    <circle cx="18" cy="158" r="7" fill="#fff" opacity=".55"/>`,reflux:`
    ...
    <path d="M79 205a41 41 0 0 0 82 0z" fill="#fff" opacity=".28"/>`,sepfunnel:`
    ...
    <path d="M120 262v14" stroke="#fff" stroke-width="5" stroke-linecap="round" opacity=".8"/>`,ir:`
    ...
    <path d="M62 244v10M110 244v10M158 244v10M206 244v10" stroke="#fff" stroke-width="4" stroke-linecap="round" opacity=".35"/>`,nmr:`
    ...
    <circle cx="150" cy="106" r="5" fill="#fff" opacity=".45"/>`,vanillin:`
    ...
    <circle cx="104" cy="128" r="3.5" fill="#fff" opacity=".4"/>`},s=[`erlenmeyer`,`benzene`,`reflux`,`sepfunnel`,`ir`,`nmr`,`attack`,`resonance`,`pka`,`vanillin`,`iodosalicylamide`,`chalcone`,`mascot`],c=`0 0 240 320`;function l(e,t=`currentColor`){return o[e].replace(/#fff\b/g,t)}function u(e,t,n,r){if(r)return`./cards/${r}`;let i=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240 320" width="240" height="320">
  <defs>
...
</svg>`;return`data:image/svg+xml;utf8,${encodeURIComponent(i.replace(/\s+/g,` `))}`}var d=[`list`,`carousel`,`scroll`,`stack`,`gallery`,`table`];function f(e,t){return e?.[t]??!0}var p=[{id:`lab`,photo:`backgrounds/folder-blueberry.webp`,title:`LCTA`,blurb:`One deck per experiment, written for the lab critical thinking assessment.`,from:`#4338ca`,to:`#6d28d9`},{id:`reference`,photo:`backgrounds/folder-cool-dark-blueberry.webp`,title:`Reference sheets`,blurb:`The charts you look up mid-problem. Hover any row for the diagram.`,from:`#7c3aed`,to:`#9333ea`},{id:`carbonyls`,photo:`backgrounds/folder-tart-blueberry.webp`,title:`Carbonyls`,blurb:`One deck per reaction type, plus the same reactions asked backwards.`,from:`#8b5cf6`,to:`#a855f7`},{id:`uploaded`,photo:`backgrounds/folder-pancake-blueberry.webp`,title:`Uploaded`,blurb:`Decks added from a text file.`,from:`#a21caf`,to:`#c026d3`}],m=[{id:`ochem1`,title:`Organic Chemistry I`},{id:`ochem2`,title:`Organic Chemistry II`,children:[{id:`ochem2-lessons`,title:`Lessons`},{id:`ochem2-lab`,title:`Lab`,folders:[`lab`,`reference`,`carbonyls`]}]},{id:`uploads`,title:`Uploaded`,folders:[`uploaded`]}];function h(e){return[...e.folders??[],...(e.children??[]).flatMap(h)]}function g(e){return e.kind===`reference`}function _(e){return g(e)?e.groups.reduce((e,t)=>e+t.items.length,0):e.questions.length}function v(e){if(!e.some(e=>e.image))return[];let t=[];for(let n of e){let e=n.heading??``,r=t.find(t=>t.heading===e);r||(r={heading:e||void 0,items:[]},t.push(r)),r.items.push({title:n.q,description:n.a,badge:n.badge??``,image:n.image})}return t}function y(e){return e.href??`#/deck/${e.id}`}var b=e(t(),1),x=e(i(),1);function S({sound:e=!0,storageKey:t=`theme`}){let n=`att${(0,b.useId)().replace(/:/g,``)}`,[i,a]=(0,b.useState)(()=>typeof document<`u`&&document.documentElement.classList.contains(`dark`)),o=(0,b.useRef)(null),s=()=>{let e=document.documentElement;e.classList.add(`theme-transition`),o.current&&clearTimeout(o.current),o.current=setTimeout(()=>{e.classList.remove(`theme-transition`),o.current=null},260);let n=e.classList.toggle(`dark`);a(n);try{localStorage.setItem(t,n?`dark`:`light`)}catch{}},c={type:`spring`,stiffness:380,damping:30};return(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(`style`,{children:`
        .att-btn{--at-ink:rgba(0,0,0,0.82)}
        .dark .att-btn,[data-theme="dark"] .att-btn{--at-ink:rgba(255,255,255,0.82)}
      `}),(0,x.jsx)(r.button,{className:`att-btn`,...e?{}:{"data-click-silent":!0},onClick:s,whileHover:{scale:1.1},whileTap:{scale:.86},transition:{type:`spring`,stiffness:400,damping:25},style:{background:`none`,border:`none`,cursor:`pointer`,padding:8,display:`flex`,alignItems:`center`,justifyContent:`center`,color:`var(--at-ink)`,borderRadius:9999,outline:`none`,position:`relative`,WebkitTapHighlightColor:`transparent`},"aria-label":i?`Switch to light theme`:`Switch to dark theme`,"aria-pressed":i,title:i?`Switch to light theme`:`Switch to dark theme`,children:(0,x.jsxs)(r.svg,{width:`20`,height:`20`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,strokeLinecap:`round`,initial:!1,animate:{rotate:i?270:0},transition:c,style:{overflow:`visible`},children:[(0,x.jsxs)(`mask`,{id:n,children:[(0,x.jsx)(`rect`,{x:`0`,y:`0`,width:`100%`,height:`100%`,fill:`white`}),(0,x.jsx)(r.circle,{initial:!1,animate:{cx:i?17:33,cy:i?8:0},transition:c,r:`9`,fill:`black`})]}),(0,x.jsx)(r.circle,{cx:`12`,cy:`12`,fill:`currentColor`,stroke:`none`,mask:`url(#${n})`,initial:!1,animate:{r:i?9:5},transition:c}),(0,x.jsxs)(r.g,{initial:!1,animate:{opacity:+!i,scale:+!i,rotate:i?-30:0},transition:c,style:{transformOrigin:`12px 12px`},children:[(0,x.jsx)(`line`,{x1:`12`,y1:`1`,x2:`12`,y2:`3`}),(0,x.jsx)(`line`,{x1:`12`,y1:`21`,x2:`12`,y2:`23`}),(0,x.jsx)(`line`,{x1:`1`,y1:`12`,x2:`3`,y2:`12`}),(0,x.jsx)(`line`,{x1:`21`,y1:`12`,x2:`23`,y2:`12`}),(0,x.jsx)(`line`,{x1:`5.64`,y1:`5.64`,x2:`4.22`,y2:`4.22`}),(0,x.jsx)(`line`,{x1:`18.36`,y1:`5.64`,x2:`19.78`,y2:`4.22`}),(0,x.jsx)(`line`,{x1:`5.64`,y1:`18.36`,x2:`4.22`,y2:`19.78`}),(0,x.jsx)(`line`,{x1:`18.36`,y1:`18.36`,x2:`19.78`,y2:`19.78`})]})]})})]})}export{f as a,h as c,s as d,c as f,a as h,p as i,g as l,l as m,d as n,_ as o,u as p,m as r,y as s,S as t,v as u};